# Deployment script for HAILE AI Avatar -- Dallas demo (eastus)
# Deploys to a SEPARATE resource group so it doesn't affect the Sweden deployment.
# Tear down after demo with: .\teardown-dallas.ps1

# ==================== CONFIGURATION ====================

$RESOURCE_GROUP = "rg-haile-dallas"
$LOCATION = "southcentralus"       # San Antonio, TX — closest Azure region to Dallas
$ENVIRONMENT = "dallas"
$SWA_LOCATION = "centralus"        # SWA-supported region near Dallas

Write-Host "Deploying HAILE AI Avatar (DALLAS DEMO)" -ForegroundColor Cyan
Write-Host "==============================================" -ForegroundColor Cyan
Write-Host "Resource Group: $RESOURCE_GROUP"
Write-Host "Location: $LOCATION"
Write-Host "Environment: $ENVIRONMENT"
Write-Host "SWA Location: $SWA_LOCATION"
Write-Host ""
...
az deployment group create `
    ...
    --parameters environment=$ENVIRONMENT swaLocation=$SWA_LOCATION appServiceSkuName=B1 `
    --output none
...
Write-Host ""
Write-Host "==============================================" -ForegroundColor Cyan
Write-Host "DALLAS DEMO -- Deployment complete!" -ForegroundColor Green
Write-Host "==============================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "Frontend:    $SWA_URL" -ForegroundColor Green
Write-Host "Backend API: $API_URL" -ForegroundColor Green
Write-Host ""
Write-Host "To tear down after the demo, run:" -ForegroundColor Yellow
Write-Host "  .\teardown-dallas.ps1" -ForegroundColor Yellow
